...
const MARKDOWN_DEMO = `# 轻言 Markdown 语法参考
...
function App(): React.JSX.Element {
  ...
  const [notes] = useState([
    { id: "1", title: "Markdown 语法参考", updatedAt: "刚刚", isPinned: true },
    { id: "2", title: "快速开始指南", updatedAt: "1小时前" },
    { id: "3", title: "项目计划", updatedAt: "2小时前" },
    { id: "4", title: "会议记录", updatedAt: "昨天" }
  ]);
  ...
  const handleSelectNote = (noteId: string) => {
    ...
    // 第一篇笔记显示完整的 Markdown 语法参考
    if (noteId === "1") {
      setEditorContent(MARKDOWN_DEMO);
    } else {
      setEditorContent(`# 笔记示例
