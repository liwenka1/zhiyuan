  ...
  return (
    <section className="px-4 py-8 md:py-10">
      <div className="container mx-auto max-w-6xl">
        <Reveal className="grid gap-10 border-y border-border/60 py-10 md:grid-cols-[0.9fr_1.1fr] md:py-12">
          ...
          {t.items.map((item, index) => {
            ...
            return (
              <Reveal
                key={item.title}
                delay={index * 80}
                className="rounded-3xl border border-border/60 bg-card/55 p-6 backdrop-blur-sm"
              >
