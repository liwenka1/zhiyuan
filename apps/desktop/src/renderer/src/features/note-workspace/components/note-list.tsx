...
export function NoteList({
  ...
  return (
    ...
    >
      ...
      >
        {isImportingExternal && (
          <div className="border-divider bg-background/80 text-muted-foreground absolute top-2 right-2 left-2 z-10 rounded-md border px-2 py-1 text-center text-xs backdrop-blur-sm">
